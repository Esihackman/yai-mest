    ...
    <section className="w-full py-24 bg-gradient-to-b from-white to-gray-50" id="contact">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold text-blue-800 mb-4 tracking-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-lg space-y-6 transform transition-all duration-300 hover:shadow-xl">
              ...
              <div className="space-y-6 text-lg">
                <a href="mailto:assuahrobotics@example.com" 
                  ...
                  <Mail className="text-gray-600 w-6 h-6 group-hover:scale-110 transition-transform" />
                  <span className="text-gray-700 group-hover:text-gray-900">assurobotics@gmail.com
                  </span>
                </a>
                <a href="tel:+233123456789"
                   className="flex items-center space-x-4 p-4 rounded-2xl hover:bg-gray-50 transition-colors group">
                  <Phone className="text-gray-600 w-6 h-6 group-hover:scale-110 transition-transform" />
                  <span className="text-gray-700 group-hover:text-gray-900">+233200404997 / +233200404993
                  </span>
                </a>
                <div className="flex items-center space-x-4 p-4 rounded-2xl hover:bg-gray-50 transition-colors group">
                  <MapPin className="text-gray-600 w-6 h-6 group-hover:scale-110 transition-transform" />
                  <span className="text-gray-700 group-hover:text-gray-900">Sekondi-Takoradi, Ghana</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-lg transform transition-all duration-300 hover:shadow-xl">
            <h3 className="text-2xl font-semibold text-green-700 mb-6">Send a Message</h3>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  required
                  placeholder=""
                  className="w-full p-4 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all duration-200"
                />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  placeholder=""
                  rows="5"
                  className="w-full p-4 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all duration-200 resize-none"
                ></textarea>
              </div>
              <button
                type="submit"
                disabled={isSubmitting || submitted}
                className={`w-full bg-green-600 hover:bg-green-700 text-white px-6 py-4 rounded-2xl text-lg font-medium shadow-lg 
